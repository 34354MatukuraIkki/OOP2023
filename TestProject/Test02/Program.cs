...
namespace Test02 {
    class Program {
        ...
        private static void Exercise02(List<int> numbers) {
            var maxNumber = numbers.Where(n => n % 2 == 0);
        ...
        private static void Exercise03(List<int> numbers) {
            var numbersUp = numbers.OrderBy(n => n);
            Console.Write(numbersUp.First());
            foreach (var number in numbersUp.Skip(1)) {
        ...
        private static void Exercise04(List<int> numbers) {
            ...
            foreach (var n in number.Skip(1)) {
                Console.Write(" {0}", n);
            }
        }
    }
