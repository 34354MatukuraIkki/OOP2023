...
namespace Exercise02 {
    class Program {
        ...
        private static void Exercise2_2(List<Book> books) {
            ...
            var bookCount = books.Count(str => str.Title.Contains("C#"));
            Console.WriteLine("{0}冊",bookCount);
        }

        private static void Exercise2_3(List<Book> books) {
            var bookC = books.Where(str => str.Title.Contains("C#")).Average(x=>x.Pages);
            Console.WriteLine("平均ページ数：{0}", bookC);
        }
        ...
        private static void Exercise2_6(List<Book> books) {
            var bookPrice = books.Where(n => n.Pages >= 400).OrderByDescending(x => x.Price);
        ...
        private static void Exercise2_7(List<Book> books) {
            var bookC = books.Where(str => str.Title.Contains("C#") && str.Pages <= 500);
            foreach (var book in bookC) {
